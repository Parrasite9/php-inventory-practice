...
Read LEARNING_GUIDE.md before teaching. Its “Inventory project starting point” supersedes the copied queue-project progress note.

- This is a learning project. Do not complete learner exercises unless explicitly asked.
- Default to one short task per response, with an explicit file/location and starting state.
